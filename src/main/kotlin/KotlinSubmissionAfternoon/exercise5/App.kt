package KotlinSubmissionAfternoon.exercise5
...
fun main() {
    ...
    hero.setProfile("Ricky Ageng Saputra", 21, 173)
     ...
     */
    println("\n")
    println("Ini merupakan status sebelum mekakukan aktifitas")
    hero.profile()
    println("\n")
     ...
     *
     */
    println("Aktifitas yang saya jalankan sesuai challenge kelompok Serenity")
    println("================================================================")
     ...
     *
     */
    println("Ini merupakan status terkini setelah mekakukan aktifitas")
    hero.profile()
